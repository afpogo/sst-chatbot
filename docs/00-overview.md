...
## Current State
- CR-SST-0224: [contratos iniciales del pipeline de artículos](architecture/article-processing-pipeline.md), sin conexión a proveedores ni persistencia todavía.
